...
1 dataset, 29 analysts and 20 outcomes. `
)}
...
function _chart(SankeyChart,analysis,nodeAlign,linkColor,d3,width){return(
SankeyChart({
  links: analysis
}, {
  nodeGroup: d => String(d.id).split(/\W/)[0], // take first word for color
...
function _analysis(FileAttachment){return(
FileAttachment("sankey2@2.csv").csv({typed: true})
)}

function _6(FileAttachment){return(
FileAttachment("sankey2@2.csv").csv()
)}
...
function SankeyChart({
  ...
  nodeWidth = 0, // width of node rects
  ...
  colors = ["#17019A","#6495ED","#EE8C2C","#ccccff","#ea487e","#800020","#b0c4de","#FAC564"], // array of colors
  width =600, // outer width, in pixels
  height = 10, // outer height, in pixels
...
function _9(FileAttachment){return(
FileAttachment("sankey2@2.csv").csv()
)}
...
function _analysis2(FileAttachment){return(
FileAttachment("sankey2@2.csv").csv()
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["sankey2@2.csv", {url: new URL("./files/3d55e377ed35f4f8b98c0933c183f449953c65987d3e1f33d0d2083157af6b5a2592d2d8a5638cb43ec16457f5368308c68cfc75cf432b6b71999229f43ad62e.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
  ...
  main.variable(observer("chart")).define("chart", ["SankeyChart","analysis","nodeAlign","linkColor","d3","width"], _chart);
  main.variable(observer("analysis")).define("analysis", ["FileAttachment"], _analysis);
  ...
  main.variable(observer()).define(["FileAttachment"], _9);
  main.variable(observer()).define(["md"], _10);
  main.variable(observer("d3Sankey")).define("d3Sankey", ["require","d3"], _d3Sankey);
  const child1 = runtime.module(define1);
  main.import("howto", child1);
  main.variable(observer("analysis2")).define("analysis2", ["FileAttachment"], _analysis2);
  return main;
}
